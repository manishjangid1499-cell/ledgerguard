...
import { Funding, Payout, Payment, PaymentDetail, Refund, Page, Posted, PaymentRequest } from './types';
...
export const financialApi = {
  ...
  payments: (page = 0) => apiClient<Page<Payment>>(`/api/payments?page=${page}&size=10`),
